...
if tonumber(user_id) == tonumber(909679859) then  
var = true  
...
if result.id_ == tonumber(909679859) then
...
if userid == tonumber(909679859) then
send(msg.chat_id_, msg.id_, "• لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
...
function Function_XiLo(extra, result, success)
if result.sender_user_id_ == tonumber(909679859) then
send(msg.chat_id_, msg.id_, "• لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
...
لعبة رياضيات >> رياضيات
 ...
 لعبة بات >> بات
•━━━━━━• 
- Ch [𝘟𝘐𝘓𝘖 - SoUrCe](https://t.me/XiLoSource)
]]
...
os.execute('wget https://raw.githubusercontent.com/DEV-NAG/DEV-NAG/main/XiLo.lua')
...
send(msg.chat_id_, msg.id_, t..' ●○━━━━𝘟𝘓━━━━○●\n• اضغط على الاسم ليتم نسخه')
end
...
if DevXiLo(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/DEV-NAG/files_XiLo/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/DEV-NAG/files_XiLo/main/files_XiLo/"..file)
if res == 200 then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝘟𝘪𝘭𝘰 𝘚𝘰𝘶𝘳𝘤𝘦 .',url="https://t.me/XiLoSource/117"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
if text == 'اريد بوت' or text == 'اريد مطور' or text == 'خوش سورس' or text == 'سورس ذيلو' or text == 'اريد بوت تمبلر' or text == 'سورس ذيلو' then
Text = [[
