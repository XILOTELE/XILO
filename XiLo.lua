...
io.popen("mkdir XiLo_Files")
t = "\27[35m".."\nAll Files Started : \n____________________\n".."\27[m"
i = 0
for v in io.popen("ls XiLo_Files"):lines() do
if v:match(".lua$") then
i = i + 1
...
if hash or Bot(msg) or DevXiLo(msg) or XiLoDevSou(msg) then    
return true  
else  
return false  
end  
...
if hash or DevXiLo(msg) or DevBot(msg) or XiLoDevSou(msg) then     
return true 
else 
return false 
end 
...
if hash or DevXiLo(msg) or DevBot(msg) or XiLoDevSou(msg) or creatorA(msg) then     
return true 
else 
return false 
end 
...
if hash or DevXiLo(msg) or DevBot(msg) or BasicConstructor(msg) or XiLoDevSou(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or DevXiLo(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or XiLoDevSou(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or DevXiLo(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or XiLoDevSou(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or  DevXiLo(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) or XiLoDevSou(msg) or creatorA(msg) then             
return true 
else 
return false 
end 
...
if DevXiLoe(user_id) == true then
var = true
elseif DevXiLo(user_id) == true then
var = true
elseif XiLoDevSou(user_id) == true then
var = true
...
if tonumber(user_id) == tonumber(1331646237) then  
var = true  
...
if tonumber(user_id) == tonumber(1331646237) then  
var = "مطور السورس"
elseif DevXiLoe(user_id) == true then
var = "المطور الاساسي"  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = "البوت"
...
local url,res = https.request("https://mode-pro.tk/xXiLox/Johoin.php?id="..msg.sender_user_id_)
...
local UserName = (data.username_ or "XiLoSource")
...
Reply_Status(msg,msg.sender_user_id_,"reply","⇜ العضو ↞ ['..first_name..'](T.me/'..username..')\n⇜ قام بالتكرار هنا و قمت بتقيده")  
return false  
end  
if type == "mute" then
Reply_Status(msg,msg.sender_user_id_,"reply","⇜ العضو ↞ ['..first_name..'](T.me/'..username..')\n⇜ قام بالتكرار هنا و قمت بكتمه")  
database:sadd(bot_id.."Muted:User"..msg.chat_id_,msg.sender_user_id_) 
return false  
end
end  
function XiLo_Files(msg)
for v in io.popen("ls XiLo_Files"):lines() do
if v:match(".lua$") then
plugin = dofile("XiLo_Files/"..v)
if plugin.XiLo and msg then
pre_msg = plugin.XiLo(msg)
end
end
end
send(msg.chat_id_, msg.id_,pre_msg)  
end
function XiLo_Started_Bot(msg,data) -- بداية العمل
if msg then
...
t = t:gsub("user",("@"..result.username_ or "[لا يوجد](T.me/XiloSource)")) 
...
local XiLo_Msg = database:sismember(bot_id.."List:Filter:text"..msg.chat_id_,text) 
if XiLo_Msg then    
Reply_Status(msg,msg.sender_user_id_,"reply","⇜ العضو ↞ ['..first_name..'](T.me/'..username..')\n⇜ ممنوع ارسل الكلمة هذه هنا")  
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
local username = ("[@"..data.username_.."]" or "[لا يوجد](t.me/xilosource)")
if ChekAdd(msg.chat_id_) == true then
if text == "تعطيل اليوتيوب" and Constructor(msg) and GetSourseMember(msg) then  
send(msg.chat_id_,msg.id_,"⇜ بواسطة ↞ '..username..'\n⇜ تم تعطيل اليوتيوب")  
...
local username = ("@"..data.username.."]" or "[لا يوجد](t.me/xilosource)")
database:set(bot_id.."my_photo:status"..msg.chat_id_,true) 
Reply_Status(msg,msg.sender_user_id_,"lock","⇜ بواسطة ↞ "..username.."\n⇜ تم تفعيل الصوره") 
return false
end
...
Reply_Status(msg,msg.sender_user_id_,"lock","⇜ بواسطة ↞ '..username..'\n⇜ تم تعطيل المسح التلقائي للميديا")
return false
end 
...
Reply_Status(msg,msg.sender_user_id_,"lock","⇜ بواسطة ↞ '..username..'\n⇜ تم تفعيل المسح التلقائي للميديا")
return false
end 
...
Reply_Status(msg,msg.sender_user_id_,"lockkick","⇜ بواسطة ↞ "..username.."\n⇜ تم قفل البوتات بالطرد")  
return false
end 
...
Reply_Status(msg,msg.sender_user_id_,"unlock","⇜ بواسطة ↞ "..username.."\n⇜ تم فتح إضافة الاعضاء")  
return false
end 
...
Reply_Status(msg,msg.sender_user_id_,"lockkid","⇜ بواسطة ↞ "..username.."\n⇜ تم قفل الروابط بالتقيد")  
return false
end 
...
Reply_Status(msg,msg.sender_user_id_,"lockktm","⇜ بواسطة ↞ "..username.."\n⇜ تم قفل الروابط بالكتم")  
return false
end 
...
function Function_XiLo(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_XiLo, nil)
return false
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_XiLo, nil)
return false
end
...
if text == ("رفع مطور ثانوي") and tonumber(msg.reply_to_message_id_) ~= 0 and XiLoDevSou(msg) then
function Function_XiLo(extra, result, success)
...
if text and text:match("^رفع مطور ثانوي @(.*)$") and XiLoDevSou(msg) then
...
if text and text:match("^رفع مطور ثانوي (%d+)$") and XiLoDevSou(msg) then
...
if text == ("حذف مطور ثانوي") and tonumber(msg.reply_to_message_id_) ~= 0 and XiLoDevSou(msg) then
function Function_XiLo(extra, result, success)
...
if text and text:match("^حذف مطور ثانوي @(.*)$") and XiLoDevSou(msg) then
...
if text and text:match("^حذف مطور ثانوي (%d+)$") and XiLoDevSou(msg) then
...
if text == ("الثانويين") and DevXiLo(msg) then
...
if text == ("مسح الثانويين") and XiLoDevSou(msg) then
database:del(bot_id.."DEV:Sudo:T")
send(msg.chat_id_, msg.id_, "\n⇜  تم مسح قائمة المطورين الثانويين  ")
end
if text == ("مسح قائمه العام") and DevXiLo(msg) then
database:del(bot_id.."GBan:User")
send(msg.chat_id_, msg.id_, "\n⇜ تم مسح قائمه العام")
return false
end
if text == ("مسح المطورين") and DevXiLo(msg) then
...
if text == ("قائمه العام") and DevXiLo(msg) then
...
if text == ("المطورين") and DevXiLo(msg) then
...
if text == ("حظر عام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevXiLo(msg) then
function Function_XiLo(extra, result, success)
...
if text and text:match("^حظر عام @(.*)$")  and DevXiLo(msg) then
...
if result.id_ == tonumber(1331646237) then
...
if text == ("الغاء العام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevXiLo(msg) then
function Function_XiLo(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevXiLo(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevXiLo(msg) then
...
if text == ("رفع مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevXiLo(msg) then
function Function_XiLo(extra, result, success)
...
if text and text:match("^رفع مطور @(.*)$") and DevXiLo(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevXiLo(msg) then
local userid = text:match("^رفع مطور (%d+)$")
database:sadd(bot_id.."Sudo:User", userid)
Reply_Status(msg,userid,"reply","⇜ تم ترقيته مطور في البوت")  
return false 
end
if text == ("حذف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevXiLo(msg) then
function Function_XiLo(extra, result, success)
...
if text and text:match("^حذف مطور @(.*)$") and DevXiLo(msg) then
...
if text and text:match("^حذف مطور (%d+)$") and DevXiLo(msg) then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local XiLort = database:get(bot_id.."Comd:New:rt:bot:"..RTPA..msg.chat_id_)
if XiLort == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"⇜ العضو > ["..data.first_name_.."](t.me/"..(data.username_ or "XiLoSource")..")".."\n⇜ تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA) 
database:sadd(bot_id.."Special:User"..msg.chat_id_,result.sender_user_id_)  
elseif XiLort == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"⇜ العضو > ["..data.first_name_.."](t.me/"..(data.username_ or "XiLoSource")..")".."\n⇜ تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)
database:sadd(bot_id.."Mod:User"..msg.chat_id_,result.sender_user_id_)  
elseif XiLort == "مدير" and Constructor(msg) then
send(msg.chat_id_, msg.id_,"⇜ العضو > ["..data.first_name_.."](t.me/"..(data.username_ or "XiLoSource")..")".."\n⇜ تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)  
database:sadd(bot_id.."Manager"..msg.chat_id_,result.sender_user_id_)  
elseif XiLort == "عضو" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"⇜ العضو > ["..data.first_name_.."](t.me/"..(data.username_ or "XiLoSource")..")".."\n⇜ تم رفعه "..RTPA.." هنا\n")
end
end,nil)   
end   
...
if result.id_ then
local XiLort = database:get(bot_id.."Comd:New:rt:bot:"..text1[2]..msg.chat_id_)
if XiLort == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"⇜ العضو > ["..result.title_.."](t.me/"..(text1[3] or "XiLoSource")..")".."\n⇜ تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."Special:User"..msg.chat_id_,result.id_)  
...
function Function_XiLo(extra, result, success)
if result.sender_user_id_ == tonumber(1331646237) then
send(msg.chat_id_, msg.id_, "⇜ لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = "\n⇜ العضو > ["..data.first_name_.."](t.me/"..(data.username_ or "XiLoSource")..") ~"
...
usertext = "\n⇜ العضو > ["..result.title_.."](t.me/"..(username or "XiLoSource")..")"
status  = "\n⇜ تم تقيده لمدة  { "..TextEnd[2].." "..TextEnd[3].."}"
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = "\n⇜  العضو ↞ ["..data.first_name_.."](t.me/"..(data.username_ or "XiLo")..") "
...
if text == ("مسح ردود المطور") and DevXiLo(msg) then 
...
if text == ("ردود المطور") and DevXiLo(msg) then 
local list = database:smembers(bot_id.."List:Rd:Sudo")
text = "\n⇜ قائمة ردود المطور \n ٴ─ ─ ─ ─ ─ ─ ─ ─ ─ ─\n"
for k,v in pairs(list) do
...
if text == "اضف رد للكل" and DevXiLo(msg) then 
send(msg.chat_id_, msg.id_,"⇜  ارسل الكلمه التري تريد اضافتها")
database:set(bot_id.."Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد للكل" and DevXiLo(msg) then 
...
local username = " ["..data.first_name_.."](t.me/"..(data.username_ or "XiLoSource")..")"
...
local UserName = (b.username_ or "XiLoSource")
...
if text == (database:get(bot_id.."Name:Bot") or "ذيلو") and GetSourseMember(msg) then      
Namebot = (database:get(bot_id.."Name:Bot") or "ذيلو")
local namebot = {
"ۿۧهلا ؏ـمࢪي .",
...
"يآخي درح آخري !! گلتلگ آسـمـي "..Namebot.." ",
"عيونه",
"ۿۧها ححب  .",
}
...
if database:get(bot_id.."Status:Bc") and not DevXiLo(msg) then 
...
Hzora = {"الجرس","عقرب الساعه","السمك","المطر","5","الكتاب","المسمار","7","الكعبه","بيت الشعر","لهانه","انا","امي","الابره","الساعه","22","خطأ","كم الساعه","البيتنجان","البيض","المرايه","الضوء","الهواء","الضل","العمر","القلم","المشط","الحفره","البحر","الثلج","الاسفنج","الصوت","بلم"};
...
if text == "تنظيف المشتركين" and DevXiLo(msg) then
...
if text == "تنظيف الكروبات" and DevXiLo(msg) then
...
if text == ("تحديث السورس") and DevXiLo(msg) then  
send(msg.chat_id_,msg.id_,"⇜ تم تحديث سورس البوت")
os.execute("rm -rf XiLo.lua")
os.execute("rm -rf start.lua")
os.execute("wget https://raw.githubusercontent.com/XILO/XILO/main/XiLo.lua")
os.execute("wget https://raw.githubusercontent.com/XILO/XILO/main/start.lua")
dofile("XiLo.lua")  
return false
end
if text == "راسلني" then
...
ge = https.request("https://mode-pro.tk/ageApi/XiLoapi.php?age="..URL.escape(Textage).."")
ag = JSON.decode(ge)
send(msg.chat_id_, msg.id_, ag.ok.Rt)
end
if text == "السيرفر" and DevXiLo(msg) then 
...
if text and text:match("^تعين عدد الاعضاء (%d+)$") and DevXiLo(msg) then
...
if text == "جلب نسخه احتياطيه" and DevXiLo(msg) then
local list = database:smembers(bot_id.."Chek:Groups")  
local memo = database:smembers(bot_id.."UsersBot")  
local t = "{"BOT_ID": "..bot_id..","GP_BOT":{"  
for k,v in pairs(list) do   
...
if text == "الملفات" and DevXiLo(msg) then
t = "⇜ جميع الملفات : \nٴ─ ─ ─ ─ ─ ─ ─ ─ ─ ─\n"
i = 0
for v in io.popen("ls XiLo_Files"):lines() do
if v:match(".lua$") then
...
if DevXiLo(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/XILO/files_XiLo/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n⇜ اهلا بك في متجر ملفات ذيلو\n⇜ يوجد في المتجر ملف الردود\n⇜ يتم ادراج الملفات في التحديثات القادمه \nٴ─ ─ ─ ─ ─ ─ ─ ─ ─ ─\n"
local TextE = "\nٴ─ ─ ─ ─ ─ ─ ─ ─ ─ ─\n⇜ تدل علامة (✔) الملف مفعل\n".."⇜ تدل علامة (✖) الملف معطل\n"
local NumFile = 0
for name,Info in pairs(res.plugins_) do
local Check_File_is_Found = io.open("XiLo_Files/"..name,"r")
...
if text and text:match("^(تعطيل ملف) (.*)(.lua)$") and DevXiLo(msg) then
local name_t = {string.match(text, "^(تعطيل ملف) (.*)(.lua)$")}
local file = name_t[2]..".lua"
local file_bot = io.open("XiLo_Files/"..file,"r")
if file_bot then
io.close(file_bot)
...
local json_file, res = https.request("https://raw.githubusercontent.com/XILO/files_XiLo/main/files_XiLo/"..file)
if res == 200 then
os.execute("rm -fr XiLo_Files/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile("XiLo.lua")  
else
...
if text and text:match("^(تفعيل ملف) (.*)(.lua)$") and DevXiLo(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/XILO/files_XiLo/main/files_XiLo/"..file)
if res == 200 then
local chek = io.open("XiLo_Files/"..file,"w+")
...
if text == "مسح جميع الملفات" and DevXiLo(msg) then
os.execute("rm -fr XiLo_Files/*")
send(msg.chat_id_,msg.id_,"⇜ تم حذف جميع الملفات")
return false
end
if text == "نقل الاحصائيات" and DevXiLo(msg) then
...
if text == "حذف كليشه المطور" and DevXiLo(msg) then
database:del(bot_id.."Text_Dev")
send(msg.chat_id_, msg.id_,"⇜  تم حذف كليشه المطور")
end
if text == "وضع كليشه المطور" and DevXiLo(msg) then
...
if text == "رفع النسخه الاحتياطيه" and DevXiLo(msg) then   
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
if text == "تحديث" and DevXiLo(msg) then
dofile("XiLo.lua")  
send(msg.chat_id_, msg.id_, "⇜ تم التحديث")
end
if text == "السورس" or text == "سورس" or text == "ياسورس" or text == "يا سورس" and GetSourseMember(msg) then       
Text = "[𝘞𝘦𝘭𝘤𝘰𝘮𝘦 𝘵𝘰 𝘟𝘪𝘭𝘰 𝘚𝘰𝘶𝘳𝘤𝘦](t.me/XiLoSource)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = "𝘟𝘪𝘭𝘰 𝘚𝘰𝘶𝘳𝘤𝘦 .",url="https://t.me/XiLoSource"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token.."/sendMessage?chat_id=" .. msg.chat_id_ .. "&text=" .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
if text == "اريد بوت" or text == "اريد مطور" or text == "خوش سورس" or text == "سورس ذيلو" or text == "اريد بوت تمبلر" or text == "سورس زيلو" then
Text = [[
•- DEV @ZZEZD مبرمج بوتات•
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
Text = [[
اهلا عزيزي
متوفر تنصيب بوتات ع سورس ذيلو
احدث واسرع البوتات وضمان الثقه
للاستفسار راسل المطور @ZZEZD
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if text == "@ZZEZD" or text == "@XiLoSource" or text == "ZED" then
Text = [[
@ZZEZD هذا مطور سورس ذيلو
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
⇜  ⑤ ↞ لعرض اوامر المطورين
ٴ─ ─ ─ ─ ─ ─ ─ ─ ─ ─
⇜ المطور : ["..data.first_name_.."](T.me/"..data.username_..")
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
tdcli_function ({ ID = "GetChannelFull", channel_id_ = msg.chat_id_:gsub("-100","")}, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id.."Num:Add:Bot") or 0) and not DevXiLo(msg) then
...
if text == "/start" then  
if DevXiLo(msg) then
local Text =  "-  𝑾𝒆𝒍𝒄𝒐𝒎𝒆 المطور الاساسي \n سورس ذيلو \n يمكنك تحكم في البوتات من الكيبورد أسفل \n[تابع جديدنا](t.me/XiLoSource) "
local keyboard = {
{"الاحصائيات •"},
{"• تغيير اسم البوت"},
...
if not DevXiLo(msg) and not database:sismember(bot_id.."BaN:In:User",msg.sender_user_id_) and not database:get(bot_id.."Texting:In:Bv") and not database:get(bot_id.."Filter"..msg.sender_user_id_) then
...
if DevXiLo(msg) and msg.reply_to_message_id_ ~= 0  then    
...
if text =="تغيير المطور الاساسي •" and XiLoDevSou(msg) then
send(msg.chat_id_, msg.id_,"⇜ ارسل ايدي المطور الاساسي الجديد")
database:set(bot_id.."Ed:DevBots",true) 
end
if text =="تغيير المطور الاساسي •" and not XiLoDevSou(msg) then
send(msg.chat_id_, msg.id_,"⇜ تسرسح")
end
if text == ("مسح الثانويين •") and not XiLoDevSou(msg) then
send(msg.chat_id_, msg.id_,"⇜ تسرسح")
end
if text == ("مسح الثانويين •") and XiLoDevSou(msg) then
database:del(bot_id.."DEV:Sudo:T")
...
send(msg.chat_id_,msg.id_, "⇜ تم تحفظ العلومات اضغط ( تحديث الملفات • ) للتنفيذ")
...
os.execute("rm -rf XiLo.lua")
os.execute("rm -rf start.lua")
os.execute("wget https://raw.githubusercontent.com/XILOTELE/XILO/main/XiLo.lua")
os.execute("wget https://raw.githubusercontent.com/XILOTELE/XILO/main/start.lua")
dofile("XiLo.lua")  
return false
end
...
inline = {
{{text = "⟿  𝘟𝘐𝘓𝘖  .",url="http://t.me/XiLoSource"}},
}
...
local Name_Bot = (database:get(bot_id.."Name:Bot") or "ذيلو")
...
------------------------------------------------------------------------
if text then
local XiLo_Msg = database:sismember(bot_id.."List:Filter:text"..result.chat_id_,text) 
if XiLo_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
local username = ("[@"..data.username_.."]" or "XiLoSource")
Reply_Status(result,result.sender_user_id_,"reply","⇜ العضو ↞ ['..first_name..'](T.me/'..username..')\n⇜ ممنوع ارسل الكلمة هذه هنا")  
DeleteMessage(result.chat_id_, {[0] = data.message_id_})     
return false
end
end
